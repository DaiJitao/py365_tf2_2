...
from src.multi_task.mmoe.mmoe import MMoE
...
def data_preparation():
    ...
    train_df = pd.read_csv('../data/census-income.data',sep=',',names=column_names)
    test_df = pd.read_csv('../data/census-income.test',sep=',',names=column_names)
...
def main(plot):
    ...
    input_layer = Input(shape=(num_features,), name='input')#[499,]
    ...
    model.summary()
    if plot:
        plot_model(model, to_file='MMoE.png')
        print('plot:', plot)
