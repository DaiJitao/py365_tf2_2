...
use_gpu = '' # '0,1,2,3'
gpus = 4
pretrained_path = r'D:\qichezhijia\workspace\pycharm\tensorflow_worksapce\tfVersion_1.15.2\simbert\models\chinese_simbert_L-12_H-768_A-12'
...
datapath = r'D:\upload\ctr.v0.0.2\qt_similarity'
# 加载数据集
train_data = load_data(datapath + '\qt_test_sample.txt')
valid_data = load_data(datapath + '\qt_test_sample.txt')
test_data = load_data(datapath + '\qt_test_sample.txt')
...
class Evaluator(keras.callbacks.Callback):
	...
	def on_epoch_end(self, epoch, logs=None):
		...
		if val_acc > self.best_val_acc:
			...
			model.save("model/4_qt_spam_model.model")
			print("Save Model Succussfully!")
