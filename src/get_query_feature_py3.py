...
def get_data(filename, allsum):
	...
	for line in f_in:
		...
		total_feature_dict[idx]["query"] = make_feature(query,"",biz_type)
		idx += 1
		if idx%5000 == 0:
...
def save_feature(feature_dict,yesterday,output_file):
	#fw = codecs.open("/data/home/ds/chenyongsheng/ltr/data/query_title_content_count_feature/query_count_feature." + str(yesterday), "w", "utf-8")
...
if __name__=="__main__":
	...
	#data_path = '/data/home/ds/chenyongsheng/labeling_from_click/data/query_title_content_features/luntan/title_features/split_file/databu'
	#output_file = '/data/home/ds/chenyongsheng/labeling_from_click/data/query_title_content_features/luntan/title_features/title_feature.2021-06-25'
	total_feature_dict = get_data(data_path, allsum)
	save_feature(total_feature_dict,yesterday,output_file)
	print("---->ok inf:{},outf:{}".format(data_path, output_file))
