...
training_samples_file_path = "data/train.csv"
# Test samples path, change to your local path
# test_samples_file_path = tf.keras.utils.get_file("testSamples.csv",
#                                                 "file:///Users/zhewang/Workspace/SparrowRecSys/src/main"
#                                                 "/resources/webroot/sampledata/testSamples.csv")

test_samples_file_path = "data/test.csv"
...
inputs = {
    ...
    'timestamp': tf.keras.layers.Input(name='timestamp', shape=(), dtype='float32'),
...
movie_col = tf.feature_column.categorical_column_with_identity(key='movieId', num_buckets=211921)
movie_emb_col = tf.feature_column.embedding_column(movie_col, 10)
movie_ind_col = tf.feature_column.indicator_column(movie_col)  # movid id indicator columns

# user id embedding feature
user_col = tf.feature_column.categorical_column_with_identity(key='userId', num_buckets=359384)
