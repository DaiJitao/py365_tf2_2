...
use_gpu = '0,1,2,3'
gpus = 4
mf="model/qt_sim_model"
pretrained_path = 'data/chinese_simbert_L-12_H-768_A-12'
...
datapath = 'data/'
# 加载数据集
train_data = load_data(datapath + 'train_data.txt')
...
print("bert model output:",bert.model.output)
