...
deep_part = Dense(1024, activation='relu', name='deep_part1')(deep_inputs)
deep_part = Dropout(0.5, name='dropout_deep_part1')(deep_part)  # ?, 512
deep_part = Dense(1024, activation='relu', name='deep_part2')(deep_part)
deep_part = Dropout(0.3, name='dropout_deep_part2')(deep_part)  # ?, 256
deep_part = Dense(512, activation='relu', name='deep_part3')(deep_part)
deep_part = Dropout(0.1, name='dropout_deep_part3')(deep_part)  # ?, 512
deep_part = Dense(256, activation='relu', name='deep_part4')(deep_part)
deep_part = Dropout(0.1, name='dropout_deep_part4')(deep_part)  # ?, 512
